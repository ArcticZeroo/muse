...
import { InitializedNotificationSchema, SetLevelRequestSchema } from '@modelcontextprotocol/sdk/types.js';

let resolveInitializePromise: (() => void) | undefined;
...
MCP_SERVER.server.setNotificationHandler(InitializedNotificationSchema, () => {
...
export const waitForServerInitialize = () => initializePromise;